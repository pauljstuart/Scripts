...
--set termout off
column prev_sql_id       new_value v_xc_prev_sql_id noprint
column prev_child_number new_value v_xc_prev_child_no noprint
select prev_sql_id
,      prev_child_number
from   gv$session
...
-- Main Xplan SQL...
-- -----------------
set termout on lines 1000 pages 2000
...
,    ordered_hierarchy_data as (
    ...
    from   table(dbms_xplan.display_cursor('&v_xc_sql_id',to_number('&v_xc_child_no'),'&v_xc_format'))
    ),
    xplan_data1 as
    (
